...
\begin{itemize}
	\item \textbf{PI},  Institutional Development Award (IDeA) from the National Institute of General Medical Sciences of the National Institutes of Health under grant number P20GM103476. \$29,317.00\\
	      \textbf{Project: }Multivariate Statistical Analysis and Machine Learning Approaches for Heart Disease Prediction and Risk Factor Identification.
	\item \textbf{Recipient}, HBCU UP Implementation Project. Award \# 2510537.
...
\rule{\textwidth}{1pt}
\begin{itemize}
	\item \underline{M. Samarakkody}, ``\textit{\textbf{Formalizing the Classical Isoperimetric Inequality in the Two-Dimensional Case}}, Submitted.
	\item Y. Li, E. G\"uler, M. Toda, \underline{M. Samarakkody}, ``\textit{\textbf{Geometric Properties of Hypersurfaces of Right Conoids in Minkowski Spacetime}},'' Submitted.
...
\rule{\textwidth}{1pt}
\begin{itemize}
	\item \textbf{ParametricCurves.jl} --- Julia package for visualizing and analyzing parametric curves. \href{https://github.com/mirajcs/ParametricCurves.jl}{github.com/mirajcs/ParametricCurves.jl}. DOI: \href{https://doi.org/10.5281/zenodo.20140761}{10.5281/zenodo.20140761}
\end{itemize}
...
\subsection*{Posters}
\begin{itemize}
	\item ``\textit{\textbf{Formalizing the Isoperimetric Inequality in Lean 4}}'', XX Red Raider Minisymposium - Geometric Analysis and Applications, Texas Tech University, April $25^{th}, ~2026$.
...
\subsection*{Seminars}
\begin{itemize}
	\item ``\textit{\textbf{From Manifold to Machines: Formalizing Differential Geometry in Lean}}''- Probability, Differential Geometry and Mathematical Physics Seminar, Texas Tech University (April  $24^{st}$, 2026).
